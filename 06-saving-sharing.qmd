...
* @sec-getting-started covered the basics. For a deeper treatment of the same material, see [Data Visualisation Using R, for Researchers Who Don't Use R](https://psyteachr.github.io/introdataviz/) (Nordmann et al., 2022).
* For a broader course covering Quarto, data wrangling, joins and reproducible reports, see [Applied Data Skills](https://psyteachr.github.io/ads-v3/) (Nordmann & DeBruine, 2025).
...
* For statistical concepts and worked examples, [R for Data Science](https://r4ds.hadley.nz/) by Wickham, Çetinkaya-Rundel & Grolemund is freely available online.
